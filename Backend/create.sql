create table tb_genre (id bigint generated by default as identity, name varchar(255), primary key (id));
create table tb_movie (id bigint generated by default as identity, img_url varchar(255), sub_title varchar(255), synopsis varchar(1024), title varchar(255), year integer, genre_id bigint, primary key (id));
create table tb_review (id bigint generated by default as identity, text varchar(255), movie_id bigint, user_id bigint, primary key (id));
